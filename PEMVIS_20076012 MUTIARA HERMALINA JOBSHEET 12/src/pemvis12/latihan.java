...
public class latihan extends javax.swing.JFrame {
    ...
    String no, nama, posisi;
        ...
        try{
            ...
            System.out.println("SuksesDriver JDBC Ditemukan....!");
            try{
    ...
    public void tampildata(){
        ...
        tabel.addColumn("Nama Punggung");
        tabel.addColumn("Nama Pemain");
        tabel.addColumn("Posisi");  
    try{
        String sql1 = "Select * from latihan2";
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/pemvis12/off.png"))); // NOI18N
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            koneksi();
            //String sql = "delete from latihan2 where no='"+ jTextField1.getText() +"',";
            String sql = "delete from latihan2 where no='"+ jTextField1.getText() +"'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            koneksi();
            String sql = "update latihan2 set nama='"+ jTextField2.getText() +"'," +
            " posis='" + jComboBox1.getSelectedItem() + "'" +
