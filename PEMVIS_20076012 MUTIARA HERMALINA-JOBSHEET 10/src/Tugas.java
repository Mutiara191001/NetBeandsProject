...
public class Tugas extends javax.swing.JFrame {
    Connection konek;
    String kode, jenis_pelanggaran, tanggal;
    ...
    public Tugas() {
     ...
     public void koneksi(){
        try{
            ...
            System.out.println("Sukses Driver JDBC Ditemuakn...!");
            try{
            ...
            try{
                ...
                try{
                    ...
                    if(jRadioButton1.isSelected()){
                        jenis_pelanggaran = "Umum";
                    }
                    else {
                        jenis_pelanggaran = "Member";
                    }
                    stat.setString(3, jenis_pelanggaran);
