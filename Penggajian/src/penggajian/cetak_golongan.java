 ...
 * @author ASUS
 */
public class cetak_golongan extends javax.swing.JFrame {
    Connection koneksi;
    /**
     * Creates new form cetak_golongan
     */
    public cetak_golongan() {
        initComponents();
        koneksi();
        cetak();
    }
    ...
    public void cetak(){
        String html=
                "<H2><center>DATA GOLONGAN</center></H2>"+"<table width='98%'border='0' align='center' cellpadding='5' cellspacing='1'>"
                +"<tr>"
                +"<td bgcolor='#CCCCCC' align='center'><strong>Kode Golongan</strong></td>"
                +"<td bgcolor='#CCCCCC' align='center'><strong>Nama Golongan</strong></td>"
                +"<td bgcolor='#CCCCCC' align='center'><strong>Gaji Pokok</strong></td>"
                +"</tr>";
        ...
        try {
            ...
            while(set.next()){
                html=html+"<tr>"
                        +"<td bgcolor='#EEEEEE'>"+set.getString("kode_golongan")+"</td>"
                        +"<td bgcolor='#F8F8F8'>"+set.getString("nama_golongan")+"</td>"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cetak_golongan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cetak_golongan().setVisible(true);
            }
        });
    }
